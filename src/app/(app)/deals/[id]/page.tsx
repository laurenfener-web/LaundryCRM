            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2" style={{ background: "#1a3a6e" }}>
                  <th className="text-left px-3 py-2 font-bold text-white uppercase tracking-wide text-xs">Description</th>
                  <th className="text-right px-3 py-2 font-bold text-white uppercase tracking-wide text-xs">Qty</th>
                  <th className="text-right px-3 py-2 font-bold text-white uppercase tracking-wide text-xs">Unit Price</th>
                  <th className="text-right px-3 py-2 font-bold text-white uppercase tracking-wide text-xs">Total</th>
                </tr>
              </thead>
              <tbody>
